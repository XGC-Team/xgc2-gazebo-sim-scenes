...
| [`uav6_ugv4_crossing_obstacles`](worlds/uav6_ugv4_crossing_obstacles/README.md) | Manuscript-2 混合编队穿越实验的 4 个已知匀速动障碍物；模型以静态生成，恒定 twist 由 `simulation.gazebo-configure-obstacle-motion` 运行时挂载。 | — |

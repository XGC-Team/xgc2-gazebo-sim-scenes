# tunnel_straight_basic_static

隧道场景，静态布景。

World: [`tunnel_straight_basic_static.world`](tunnel_straight_basic_static.world)

![tunnel_straight_basic_static scene preview](preview.png)
